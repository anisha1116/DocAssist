...
Clone the repository or download the ZIP file from the following Git link: `https://github.com/anisha1116/DocAssist`
...
5. Hold `Ctrl` and click to open the webpage in your default browser.
...
2. Run the following command:
   ```sh
   python app.py
3. After running the command, a local connection link for the webpage will be displayed. Click on the link to open the webpage in your default browser. Input your data, and the output will be predicted using the pre-trained model.
